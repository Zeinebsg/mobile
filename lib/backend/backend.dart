...
/// Functions to query SeancesRecords (as a Stream and as a Future).
Future<int> querySeancesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SeancesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SeancesRecord>> querySeancesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SeancesRecord.collection,
      SeancesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SeancesRecord>> querySeancesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query SallesRecords (as a Stream and as a Future).
Future<int> querySallesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<SallesRecord>> querySallesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
